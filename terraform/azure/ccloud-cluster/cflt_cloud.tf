...
data "confluent_flink_region" "westeurope" {
  cloud  = var.cc_cloud_provider
  region = var.cc_cloud_region
}
...
resource "confluent_api_key" "env-manager-flink-api-key" {
  ...
  managed_resource {
    id          = data.confluent_flink_region.westeurope.id
    api_version = data.confluent_flink_region.westeurope.api_version
    kind        = data.confluent_flink_region.westeurope.kind
